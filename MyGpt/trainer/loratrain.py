...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MyGpt LoRA Fine-tuning")
    ...
    parser.add_argument("--wandb_project", type=str, default="MyGpt-LoRA", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MyGpt-LoRA-{args.lora_name}-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
