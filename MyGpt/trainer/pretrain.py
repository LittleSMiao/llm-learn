...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="My personal gpt Pretraining")
    ...
    parser.add_argument("--wandb_project", type=str, default="MyGpt-Pretrain", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MyGpt-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
